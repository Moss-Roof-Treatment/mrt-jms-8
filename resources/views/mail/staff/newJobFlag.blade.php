@component('mail::message')
  ...
  <div style="color:black;">
    ...
    <p style="margin-bottom: 30px;">Job # {{ $data['quote_identifier'] ?? '[QUOTE IDENTIFIER]' }}</p>
  </div>
  {{-- Button --}}
  <p style="margin-bottom: 30px; color:black;">To view the new job flag:</p>
  @component('mail::button', ['url' => 'https://www.mrtjms.com.au/login'])
    Click Here
  @endcomponent
  {{-- Footer --}}
