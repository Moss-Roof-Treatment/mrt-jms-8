@component('mail::message')
  ...
  <div style="color:black;">
    ...
    <p style="margin-bottom: 30px;">{!! nl2br($data['text']) !!}</p>
    <p style="margin-bottom: 30px;">Your {{ $selected_system->short_title }} tradesperson is {{ $data['tradesperson_name'] }}. To view your tradespersons profile:</p>
  </div>
  {{-- Button --}}
