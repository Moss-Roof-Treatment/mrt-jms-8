@component('mail::message')
  {{-- Heading --}}
  <img style="margin:auto; margin-bottom:20px; width:100%;" src="{{ asset('storage/images/letterheads/mrt-letter-header.jpg') }}" alt="">
  {{-- Body --}}
  ...
  {{-- Footer --}}
  <img style="margin:auto; margin-bottom: 20px; width:100%;" src="{{ asset('storage/images/letterheads/mrt-letter-deb-banner.jpg') }}" alt="">
