@component('mail::message')
  ...
  <div style="color:black;">
    ...
    <p style="margin-bottom: 30px;">{!! nl2br($data['message']) !!}</p>
    <p style="margin-bottom: 30px; text-align:center;"><b>Username:</b> {{ $data['username'] ?? '[USERNAME]' }}</p>
    <p style="margin-bottom: 30px; text-align:center;"><b>Password:</b> {{ $data['password'] ?? '[PASSWORD]' }}</p>
    <p style="margin-bottom: 30px;">Please click on the following button to login:</p>
  </div>
  {{-- Button --}}
