            ...
            <div class="col-md-8 offset-md-3">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="modal-body">
                        ...
                        <a class="btn btn-dark btn-block" href="{{ route('sms-recipient-groups.create') }}">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                        </a>
                    </div> {{-- modal-body --}}
                    </div> {{-- modal-content --}}
                ...
                {{-- reset modal --}}
                {{-- cancel button --}}
                <a href="{{ route('sms-recipient-groups.index') }}" class="btn btn-dark">
                            ...
                            <tr>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="customCheck{{ $result->customer_id }}"></label>
                                    </div>
                                </td>
                                <td>
                                    {{ $result->id }}
