...
@section('title', '- Events - Create New My Event')
  ...
  <div class="container py-5">
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <h5 class="text-primary my-3"><b>Create New Event</b></h5>
        <form action="{{ route('profile-events.store')}}" method="POST">
          @csrf
          ...
          <div class="form-group row">
            <label for="title" class="col-md-2 col-form-label text-md-right">Hex Colour</label>
            <div class="col-md-9">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('profile-events.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
