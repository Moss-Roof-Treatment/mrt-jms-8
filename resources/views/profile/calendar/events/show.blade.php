...
@section('title', '- Events - View Selected My Event')
...
<section>
  <div class="container py-5">
    ...
    <h5 class="subtitle">View Selected My Event</h5>
    {{-- title --}}

    {{-- navigation --}}
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      <div class="col pb-3">
        <a href="{{ route('profile-calendar.index') }}" class="btn btn-dark btn-block">
          <i class="fas fa-calendar-alt mr-2" aria-hidden="true"></i>View Calendar
        </a>
      </div> {{-- col pb-3 --}}
      @if ($selected_event->quote_id != null)
        <div class="col pb-3">
          <a href="{{ route('profile-jobs.show', $selected_event->quote_id) }}" class="btn btn-primary btn-block">
            <i class="fas fa-briefcase mr-2" aria-hidden="true"></i>View Job
          </a>
        </div> {{-- col pb-3 --}}
      @endif
      @if ($selected_event->is_personal == 1)
        <div class="col pb-3">
          <a href="{{ route('profile-events.edit', $selected_event->id) }}" class="btn btn-primary btn-block">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form action="{{ route('profile-events.destroy', $selected_event->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
    ...
    <form action="{{ route('profile-event-notes.store') }}" method="POST">
      @csrf
      ...
      <div class="form-group row mb-0">
        <div class="col">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <a href="{{ route('profile-events.show', $selected_event->id) }}" class="btn btn-dark btn-block">
                    <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                  </a>
                </div> {{-- modal-body --}}
              </div> {{-- modal-content --}}
          ...
          {{-- reset modal --}}
          {{-- cancel button --}}
          <a href="{{ route('profile-calendar.index') }}" class="btn btn-dark">
