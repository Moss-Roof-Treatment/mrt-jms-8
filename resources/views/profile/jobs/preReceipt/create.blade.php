...
<body>
    ...
    <div> {{-- container --}}
        ...
        <div class="page">
                ...
                <div class="col-xs-4 col-xs-offset-8">
                    <table class="table table-fullwidth bg-white text-primary" style="margin-top: 40px;">
                        <tbody>
                            ...
                            <tr>
                                <td><b>Payments / Credits:</b> - {{ $selected_quote->getFormattedQuoteTotal() }}</td>
                            </tr>
                            <tr>
                                <td><b><h4>Total: $0.00</h4></b></td>
                            </tr>
                            <tr>
            ...
            {{-- confirm genuine --}}
            <p class="text-center text-primary">This receipt is only valid after the payment has been received by the tradesperson and after the tradesperson has signed below.</p>
            <br>
            <p class="text-primary">Tradesperson Signature:</p>
