...
@section('title', '- Profile - Job Customer Notes Create')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New Customer Job Note</h5>
    {{-- title --}}
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <h5 class="text-primary my-3"><b>Create New Customer Job Note</b></h5>

        <form action="{{ route('profile-job-customer-notes.store') }}" method="POST">
          @csrf
