              ...
              <tr>
                ...
                <td class="text-center text-nowrap">
                  <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <a href="{{ route('profile-job-measurements.show', $quote->id) }}" class="btn btn-primary btn-sm mr-2">
                    ...
                    @if($quote->allow_early_receipt == 1)
                      @if($quote->getRemainingBalance() != 0) {{-- paid --}}
                        <a href="{{ route('download-pre-receipt.create', ['selected_quote_id' => $quote->id]) }}" class="btn btn-dark btn-sm mr-2">
