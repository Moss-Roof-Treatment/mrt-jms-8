...
@section('title', '- Job Notes - View Selected Customer Note')
...
<section>
  <div class="container py-5">
    ...
    <h5>View Selected Customer Note</h5>
    {{-- title --}}
    ...
    {{-- note response form --}}
    @if ($selected_note->sender_id != null)
      <a href="#" name="note-response-form"></a>
      <form action="{{ route('job-note-response.store') }}" method="POST">
        @csrf
