...
@section('title', 'Jobs - Create A New Job')
        ...
        <div class="card">
          ...
          <form action="{{ route('jobs.store') }}" method="POST">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <select name="salesperson_id" id="salesperson_id" class="custom-select">
                  ...
                  <option selected value="{{ auth()->id() }}">{{ auth()->user()->getFullNameAttribute() }}</option>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <input id="label" type="text" class="form-control @error('label') is-invalid @enderror mb-2" name="label" value="{{ old('label', $selected_customer->label) }}" placeholder="Please enter the label">
                @error('label')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-5 mb-3">
                <div class="input-group date" id="start" data-target-input="nearest">
                  <input type="text" name="inspection_date_time" class="form-control datetimepicker-input @error('start') is-invalid @enderror" data-target="#start" value="{{ old('inspection_date', date('d-m-Y - h:iA', strtotime(\Carbon\Carbon::now('Australia/Melbourne')))) }}" placeholder="Please enter the inspection start date and time"/>
  ...
  <div class="container py-5">
    ...
    <div class="row">
      <div class="col-sm-8">
        ...
        <h5 class="text-primary my-3"><b>Areas To Be Treated</b></h5>
          ...
          <div class="col-sm">
            ...
            <div class="row">
              <div class="col-md-4 my-2">
                <div class="custom-control custom-radio">
                  <input type="radio" id="buildingStyle1" name="building_style_id" class="custom-control-input @error('building_style_id') is-invalid @enderror mb-2" value="1" @if (old('building_style_id') == 1) checked @endif checked>
                  <label class="custom-control-label" for="buildingStyle1">Single Storey</label>
                </div>
              </div> {{-- col-md-4 --}}
              <div class="col-md-4 my-2">
                <div class="custom-control custom-radio">
                  <input type="radio" id="buildingStyle2" name="building_style_id" class="custom-control-input @error('building_style_id') is-invalid @enderror mb-2" value="2" @if (old('building_style_id') == 2) checked @endif>
                  <label class="custom-control-label" for="buildingStyle2">Double Storey</label>
                </div>
              </div> {{-- col-md-4 --}}
              <div class="col-md-4 my-2">
                <div class="custom-control custom-radio">
                  <input type="radio" id="buildingStyle3" name="building_style_id" class="custom-control-input @error('building_style_id') is-invalid @enderror mb-2" value="3" @if (old('building_style_id') == 3) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="house" class="custom-control-input" id="buildingTypeCheck1" @if (old('house')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="carport" class="custom-control-input" id="buildingTypeCheck2" @if (old('carport')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="veranda" class="custom-control-input" id="buildingTypeCheck3" @if (old('veranda')) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="pergola" class="custom-control-input" id="buildingTypeCheck4" @if (old('pergola')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="garage" class="custom-control-input" id="buildingTypeCheck5" @if (old('garage')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="garden_shed" class="custom-control-input" id="buildingTypeCheck6" @if (old('garden_shed')) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="barn" class="custom-control-input" id="buildingTypeCheck7" @if (old('barn')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="retirement_village" class="custom-control-input" id="buildingTypeCheck8" @if (old('retirement_village')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="industrial_shed" class="custom-control-input" id="buildingTypeCheck9" @if (old('industrial_shed')) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="house_unit" class="custom-control-input" id="buildingTypeCheck10" @if (old('house_unit')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="school_buildings" class="custom-control-input" id="buildingTypeCheck11" @if (old('school_buildings')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="church" class="custom-control-input" id="buildingTypeCheck12" @if (old('church')) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="shops" class="custom-control-input" id="buildingTypeCheck13" @if (old('shops')) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="iron" class="custom-control-input" id="roofSurfaceCheck1" @if (old('iron')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="slate" class="custom-control-input" id="roofSurfaceCheck2" @if (old('slate')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="laserlight" class="custom-control-input" id="roofSurfaceCheck3" @if (old('laserlight')) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="cement" class="custom-control-input" id="roofSurfaceCheck4" @if (old('cement')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="terracotta" class="custom-control-input" id="roofSurfaceCheck5" @if (old('terracotta')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="paint" class="custom-control-input" id="roofSurfaceCheck6" @if (old('paint')) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="solar_panels" class="custom-control-input" id="additionsCheck1" @if (old('solar_panels')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="air_conditioner" class="custom-control-input" id="additionsCheck2" @if (old('air_conditioner')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="pool_heating" class="custom-control-input" id="additionsCheck3" @if (old('pool_heating')) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="under_aerial" class="custom-control-input" id="additionsCheck4" @if (old('under_aerial')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="walls" class="custom-control-input" id="additionsCheck5" @if (old('walls')) checked @endif>
              ...
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="laserlight" class="custom-control-input" id="additionsCheck6" @if (old('laserlight')) checked @endif>
            ...
            <div class="row">
              <div class="col-sm-4 my-2">
                ...
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" name="outside_of_gutters" class="custom-control-input" id="additionsCheck7" @if (old('outside_of_gutters')) checked @endif>
        ...
        <div class="row">
          <div class="col-sm">
            ...
            <div class="form-group row">
              <div class="col-md">
                <textarea class="form-control @error('additions_other') is-invalid @enderror mb-2" type="text" name="additions_other" rows="5" placeholder="Please enter any optional other details" style="resize:none">{{ old('additions_other') }}</textarea>
        ...
        <div class="row">
          <div class="col-sm">
            ...
            <div class="form-group row">
              <div class="col-md-4 my-2">
                <div class="custom-control custom-radio">
                  <input type="radio" id="hasWaterTanks" name="has_water_tanks" class="custom-control-input @error('has_water_tanks') is-invalid @enderror mb-2" value="1" @if (old('has_water_tanks') == 1) checked @endif>
                  <label class="custom-control-label" for="hasWaterTanks">Yes</label>
                </div>
              </div> {{-- col-md-4 --}}
              <div class="col-md-4 my-2">
                <div class="custom-control custom-radio">
                  <input type="radio" id="hasNoWaterTanks" name="has_water_tanks" class="custom-control-input @error('has_water_tanks') is-invalid @enderror mb-2" value="0" @if (old('has_water_tanks') == 0) checked @endif>
        ...
        <div class="form-group row">
          <div class="col-md">
            <textarea class="form-control @error('further_information') is-invalid @enderror mb-2" type="text" name="further_information" rows="5" placeholder="Please enter any optional further information" style="resize:none">{{ old('further_information') }}</textarea>
    ...
    {{-- Quote your own roof form --}}
      ...
      <div class="form-group row">
        <div class="col-md">
          <button type="submit" class="btn btn-primary mb-2" name="action" value="continue">
            <i class="fas fa-save mr-2" aria-hidden="true"></i>Save and Continue
          </button>
          <button type="submit" class="btn btn-primary mb-2" name="action" value="finish">
            <i class="fas fa-save mr-2" aria-hidden="true"></i>Save and Finish
          </button>
          {{-- reset modal --}}
          {{-- modal button --}}
          <button type="button" class="btn btn-dark mb-2" data-toggle="modal" data-target="#exampleModalCenter">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <a href="{{ route('jobs.create') }}" class="btn btn-dark btn-block mb-3">
                    <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                  </a>
                </div> {{-- modal-body --}}
              </div> {{-- modal-content --}}
          ...
          {{-- modal --}}
          {{-- reset modal --}}
          <a href="{{ route('jobs.index') }}" class="btn btn-dark mb-2">
