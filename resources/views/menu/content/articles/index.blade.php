...
@section('title', 'Content - Articles - View All Articles')
...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('articles.create') }}" class="btn btn-primary btn-block">
          <i class="fas fa-plus mr-2" aria-hidden="true"></i>Create New Article
        </a>
      </div> {{-- col pb-3 --}}
    ...
    {{-- articles table --}}
    <h5 class="text-primary my-3"><b>All Articles</b></h5>
    @if (!$articles->count())
          ...
          <tbody>
            @foreach ($articles as $article)
              <tr>
                ...
                <td>
                  <a href="{{ route('articles.show', $article->id ) }}" class="btn btn-primary btn-sm mb-1">
                    <i class="fas fa-eye mr-2" aria-hidden="true"></i>View
                  </a>
                  <a class="btn btn-primary btn-sm mb-1" href="{{ route('articles.edit', $article->id) }}">
