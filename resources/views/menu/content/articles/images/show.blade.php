...
@section('title', 'Content - Articles - View Selected Article Image')
...
<section>
  <div class="container py-5">
    ...
    <h5>View Selected Article Image</h5>
    {{-- title --}}
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('article-images.edit', $selected_article_image->id) }}" class="btn btn-primary btn-block">
          <i class="fas fa-edit mr-2" aria-hidden="true"></i>Edit Details
        </a>
      </div> {{-- col pb-3 --}}
      <div class="col pb-3">
        <form action="{{ route('article-images.destroy', $selected_article_image->id) }}" method="POST">
          @method('DELETE')
          @csrf
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <h5 class="text-primary my-3"><b>Article Image</b></h5>
