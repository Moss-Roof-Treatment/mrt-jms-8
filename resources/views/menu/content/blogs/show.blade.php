...
@section('title', 'Content - Blogs - View Selected Blog')
...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('blogs.edit', $selected_article->id) }}" class="btn btn-primary btn-block">
          <i class="fas fa-edit mr-2" aria-hidden="true"></i>Edit
        </a>
      </div> {{-- col pb-3 --}}
      <div class="col pb-3">
        <form action="{{ route('blogs-images.create') }}" method="GET">
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form action="{{ route('blogs.destroy', $selected_article->id) }}" method="POST">
                  @method('DELETE')
                  @csrf
    ...
    <div class="row">
      ...
      <div class="col-sm-5 my-2">
        ...
        <h5 class="text-primary my-3"><b>Blog Images</b></h5>
        @if (!$selected_article->article_images->count())
          <div class="card">
