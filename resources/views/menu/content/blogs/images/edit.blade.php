...
@section('title', 'Content - Blogs - Edit Selected Blog Image')
...
<section>
  <div class="container py-5">
    ...
    <h5>Edit Selected Blog Image</h5>
    {{-- title --}}
    ...
    <div class="row">
      <div class="col-sm-8 my-2">
        ...
        <form action="{{ route('blogs-images.update', $selected_article_image->id) }}" method="POST" enctype="multipart/form-data">
          @method('PATCH')
          @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <textarea class="form-control @error('description') is-invalid @enderror mb-2" type="text" name="description" rows="5" placeholder="Please enter the description" style="resize:none">{{ $selected_article_image->description }}</textarea>
              @error('description')
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <div class="custom-file">
                <label class="custom-file-label" for="image" id="image_name">Please select a blog image to upload</label>
                <input type="file" class="custom-file-input" name="image" id="image" aria-describedby="blogImage">
              </div> {{-- custom-file --}}
              @error('image')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
          ...
          <div class="form-group row mb-0">
            <div class="col-md-9 offset-md-2">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('blogs-images.edit', $selected_article_image->id) }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- modal --}}
              {{-- reset modal --}}
              <a href="{{ route('blogs-images.show', $selected_article_image->id) }}" class="btn btn-dark">
