...
@section('title', 'Content - Blogs - Create New Blog Image')
  ...
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      <div class="col pb-3">
        <a href="{{ route('blogs.index') }}" class="btn btn-dark btn-block">
          <i class="fas fa-bars mr-2" aria-hidden="true"></i>Blogs Menu
        </a>
      </div> {{-- col pb-3 --}}
      <div class="col pb-3">
    ...
    <div class="row">
      <div class="col-sm-8 my-2">
        ...
        <form action="{{ route('blogs-images-dropzone.store') }}" class="dropzone" id="uploadImagesForm" method="POST" enctype="multipart/form-data">
          @csrf
