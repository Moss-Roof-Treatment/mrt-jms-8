...
@section('title', 'Content - Blogs - Edit Selected Blog')
...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('blogs.show', $selected_article->id) }}" class="btn btn-primary btn-block">
    ...
    <div class="row">
      <div class="col-sm-8">
        ...
        <form action="{{ route('blogs.update', $selected_article->id) }}" method="POST">
          @method('PATCH')
          @csrf
          ...
          <div class="form-group row mb-0">
            <div class="col-md-8 offset-md-3">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('blogs.edit', $selected_article->id) }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- modal --}}
              {{-- reset modal --}}
              <a href="{{ route('blogs.show', $selected_article->id) }}" class="btn btn-dark">
