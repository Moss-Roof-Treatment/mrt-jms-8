...
@section('title', 'Content - Tags - Create New Content Tag')
  ...
  <div class="container py-5">
    ...
    <div class="row">
      <div class="col-sm-8">
        ...
        <h5 class="text-primary my-3"><b>Create New Tag</b></h5>

        <form action="{{ route('content-tags.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row mb-0">
            <div class="col-md-9 offset-md-2">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('content-tags.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- modal --}}
              {{-- reset modal --}}
              <a href="{{ route('content-tags.index') }}" class="btn btn-dark">
