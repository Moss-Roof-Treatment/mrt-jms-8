...
@section('title', 'Content - Categories - View Selected Content Category')
...
<section>
  <div class="container py-5">
    ...
    <h5>View Selected Content Category</h5>
    {{-- title --}}
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('content-categories.edit', $category->id) }}" class="btn btn-primary btn-block">
      ...
      <div class="col-sm-6">
        ...
        <div class="text-center">
          @if (!$category->image_path == null)
            <img class="img-fluid shadow-sm mx-auto d-block" src="{{ asset($category->image_path) }}" alt="">
          @else
