...
@section('title', 'Customers - Create New Customer')
      ...
      <div class="col-sm-8">
        ...
        <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input id="username" type="text" class="form-control @error('username') is-invalid @enderror mb-2" name="username" value="{{ old('username') }}" placeholder="Please enter the username" autofocus>
              @error('username')
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4">
              <input class="form-control @error('password') is-invalid @enderror mb-2" type="password" name="password" placeholder="Password">
              @error('password')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <textarea class="form-control @error('user_description') is-invalid @enderror mb-2" type="text" name="user_description" rows="5" placeholder="Please enter the customer description" style="resize:none">{{ old('user_description') }}</textarea>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input id="business_position" type="text" class="form-control @error('business_position') is-invalid @enderror mb-2" name="business_position" value="{{ old('business_position') }}" placeholder="Please enter the customer position in the business">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input id="business_contact_phone" type="text" class="form-control @error('business_contact_phone') is-invalid @enderror mb-2" name="business_contact_phone" value="{{ old('business_contact_phone') }}" placeholder="Please enter the customer contact business phone">
          ...
          <div class="form-group row">
              ...
              <div class="col-md-8">
                  <textarea type="text" class="form-control @error('business_description') is-invalid @enderror mb-2" name="business_description" rows="5" placeholder="Please enter the business description" style="resize:none">{{ old('business_description') }}</textarea>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('customers.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
