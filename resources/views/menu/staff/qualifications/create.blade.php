...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      <div class="col pb-3">
        <a href="{{ route('staff-qualifications.index', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-dark btn-block">
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <form action="{{ route('staff-qualifications.store') }}" method="POST" enctype="multipart/form-data">
          @csrf

          <input type="hidden" name="staff_id" value="{{ $selected_user->id }}">

          <div class="form-group row">
            <label for="title" class="col-md-3 col-form-label text-md-right">Title</label>
            <div class="col-md-8">
              <input id="title" type="text" class="form-control @error('title') is-invalid @enderror mb-2" name="title" value="{{ old('title') }}" placeholder="Please enter the title">
              @error('title')
          ...
          <div class="form-group row">
            <label for="issue_date" class="col-md-3 col-form-label text-md-right">Issue Date</label>
            <div class="col-md-8">
              <input id="issue_date" type="date" class="form-control @error('issue_date') is-invalid @enderror mb-2" name="issue_date" value="{{ old('issue_date') }}" placeholder="Please enter the issue date">
              @error('issue_date')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="form-group row">
            <label for="expiry_date" class="col-md-3 col-form-label text-md-right">Issue Date</label>
            <div class="col-md-8">
              <input id="expiry_date" type="date" class="form-control @error('expiry_date') is-invalid @enderror mb-2" name="expiry_date" value="{{ old('expiry_date') }}" placeholder="Please enter the expiry date">
              @error('expiry_date')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="form-group row mb-0">
            <div class="col-md-8 offset-md-3">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('staff-qualifications.create', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- modal --}}
              {{-- reset modal --}}
              <a href="{{ route('staff-qualifications.index', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-dark">
