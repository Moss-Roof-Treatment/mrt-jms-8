...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      <div class="col pb-3">
        <a href="{{ route('staff-qualifications.index', ['selected_user_id' => $selected_qualification->staff_id]) }}" class="btn btn-dark btn-block">
          <i class="fas fa-id-card-alt mr-2" aria-hidden="true"></i>View Qualifications
        </a>
      </div> {{-- col pb-3 --}}
      <div class="col pb-3">
        <a href="{{ route('staff-qualifications.edit', $selected_qualification->id) }}" class="btn btn-primary btn-block">
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="confirmDeleteModalTitle">Delete</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                <p class="text-center">Are you sure that you would like to delete this qualification?</p>
