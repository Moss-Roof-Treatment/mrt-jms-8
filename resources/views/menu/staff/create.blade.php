...
@section('title', '- Staff Members - Create A New Staff Member')
    ...
    <div class="row">
      <div class="col-sm-8">
        ...
        <form action="{{ route('staff.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            <label for="user_description" class="col-md-3 col-form-label text-md-right">Staff Description</label>
            <div class="col-md-8">
              <textarea class="form-control @error('user_description') is-invalid @enderror mb-2" type="text" name="user_description" rows="5" placeholder="Please enter the staff description" style="resize:none">{{ old('user_description') }}</textarea>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input id="business_position" type="text" class="form-control @error('business_position') is-invalid @enderror mb-2" name="business_position" value="{{ old('business_position') }}" placeholder="Please enter the staff position in the business">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input id="business_contact_phone" type="text" class="form-control @error('business_contact_phone') is-invalid @enderror mb-2" name="business_contact_phone" value="{{ old('business_contact_phone') }}" placeholder="Please enter the staff contact business phone">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('staff.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
