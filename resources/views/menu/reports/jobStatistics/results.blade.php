  ...
  <div class="container py-5">
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <div class="card">
          <div class="card-body">
            @if ($total_jobs_count == null)
              <p class="text-center">There are no jobs to display</p>
            @else

              <h4 class="text-primary text-center mb-4">Total Jobs: {{ $total_jobs_count }}</h4>
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  <div class="progress my-1">
                    <div class="progress-bar" role="progressbar" style="width: {{ number_format($sold_jobs_count / $total_jobs_count * 100) . '%' }}" aria-valuenow="{{ $sold_jobs_count / $total_jobs_count * 100 }}" aria-valuemin="0" aria-valuemax="100">{{ number_format($sold_jobs_count / $total_jobs_count * 100) . '%' }}</div>
                  </div>
                </div> {{-- col-sm-8 --}}
              </div> {{-- row --}}
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  <div class="progress my-1">
                    <div class="progress-bar" role="progressbar" style="width: {{ number_format($unsold_jobs_count / $total_jobs_count * 100) . '%' }}" aria-valuenow="{{ $unsold_jobs_count / $total_jobs_count * 100 }}" aria-valuemin="0" aria-valuemax="100">{{ number_format($unsold_jobs_count / $total_jobs_count * 100) . '%' }}</div>
                  </div>
                </div> {{-- col-sm-8 --}}
              </div> {{-- row --}}
