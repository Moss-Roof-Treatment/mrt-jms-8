...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('contractor-qualifications.create', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-primary btn-block">
    ...
    @if (!$selected_qualifications->count())
      <div class="card shadow-sm mt-3">
        <div class="card-body text-center">
          <h5>There are no qualifications to display for this contractor.</h5>
        </div> {{-- card-body --}}
      </div> {{-- card --}}
    @else
      <div class="container">
        <div class="row row-cols-3">
          @foreach ($selected_qualifications as $selected_qualification)
            <div class="col">
              <div class="card">
                <div class="card-body text-center">
                  <a href="{{ route('contractor-qualifications.show', $selected_qualification->id) }}">
                  ...
                  <a href="{{ route('contractor-qualifications.show', $selected_qualification->id) }}" class="btn btn-primary">
                    <i class="fas fa-eye mr-2" aria-hidden="true"></i>View
                  </a>
                  <a href="{{ route('contractor-qualifications.edit', $selected_qualification->id) }}" class="btn btn-primary">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form action="{{ route('contractor-qualifications.destroy', $selected_qualification->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
