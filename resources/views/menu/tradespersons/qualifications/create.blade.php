...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      <div class="col pb-3">
        <a href="{{ route('tradesperson-qualifications.index', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-dark btn-block">
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <form action="{{ route('tradesperson-qualifications.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row mb-0">
            <div class="col-md-8 offset-md-3">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('tradesperson-qualifications.create', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- reset modal --}}
              {{-- cancel button --}}
              <a href="{{ route('tradesperson-qualifications.index', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-dark">
