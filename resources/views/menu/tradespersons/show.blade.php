...
@section('title', '- Tradespersons - View Selected Tradesperson')
...
<section>
  <div class="container py-5">
    ...
    <h5>View Selected Tradesperson</h5>
    {{-- title --}}
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('tradesperson-rates.index', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-primary btn-block">
          <i class="fas fa-dollar-sign mr-2" aria-hidden="true"></i>Rates
        </a>
      </div> {{-- col pb-3 --}}
      <div class="col pb-3">
        <a href="{{ route('tradesperson-qualifications.index', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-primary btn-block">
          <i class="fas fa-id-card-alt mr-2" aria-hidden="true"></i>Qualifications
        </a>
      </div> {{-- col pb-3 --}}
      <div class="col pb-3">
        <a href="{{ route('tradesperson-testimonials.index', ['selected_user_id' => $selected_user->id]) }}" class="btn btn-primary btn-block">
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <form action="{{ route('tradespersons.update', $selected_user->id) }}" method="POST" enctype="multipart/form-data">
          @method('PATCH')
          @csrf
          ...
          <h5 class="text-primary my-3"><b>Tradesperson Authentication</b></h5>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('tradespersons.show', $selected_user->id )}}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
      ...
      <div class="col-sm-5">
        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <h5 class="text-primary my-3"><b>Tradesperson Image</b></h5>
          ...
          <div class="col-sm-6">
            ...
            <h5 class="text-primary my-3"><b>Tradesperson Logo</b></h5>
