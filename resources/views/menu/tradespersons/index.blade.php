...
@section('title', 'Tradespersons - View All Tradespersons')
...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('tradespersons.create') }}" class="btn btn-primary btn-block">
          <i class="fas fa-plus mr-2" aria-hidden="true"></i>Create New Tradespersons
        </a>
      </div> {{-- col pb-3 --}}
    ...
    {{-- tradespersons table --}}
    <h5 class="text-primary my-3"><b>All Tradespersons</b></h5>
    @if (!$all_tradespersons->count())
      <div class="card">
        <div class="card-body">
          <h5 class="text-center mb-0">Threre are no technician members to display</h5>
        </div> {{-- card-body --}}
      </div> {{-- card --}}
    @else
      <div class="table-responsive mt-3">
        <table id="datatable" class="table table-bordered table-fullwidth table-striped bg-white" style="width:100%">
          ...
          <tbody>
            @foreach ($all_tradespersons as $user)
              <tr>
                <td>{{ $user->id }}</td>
                ...
                <td>
                  <a class="btn btn-primary btn-sm" href="{{ route('tradespersons.show', $user->id) }}">
