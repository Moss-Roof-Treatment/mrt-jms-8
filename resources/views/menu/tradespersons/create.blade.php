...
@section('title', '- Tradespersons - Create A New Tradesperson')
...
<section>
  <div class="container py-5">
    ...
    {{-- title --}}
    <h3 class="text-secondary mb-0">TRADESPERSONS</h3>
    <h5>Create A New Tradesperson</h5>
    {{-- title --}}

    {{-- navigation --}}
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      <div class="col pb-3">
        <a href="{{ route('tradespersons.index') }}" class="btn btn-dark btn-block">
          <i class="fas fa-bars mr-2" aria-hidden="true"></i>Tradesperson Menu
        </a>
      </div> {{-- col pb-3 --}}
    ...
    <div class="row">
      <div class="col-sm-8">
        ...
        <h5 class="text-primary my-3"><b>Tradesperson Details</b></h5>

        <form action="{{ route('tradespersons.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row">
              <label for="user_description" class="col-md-3 col-form-label text-md-right">Tradesperson Description</label>
              <div class="col-md-8">
                  <textarea class="form-control @error('user_description') is-invalid @enderror mb-2" type="text" name="user_description" rows="5" placeholder="Please enter the tradesperson description" style="resize:none">{{ old('user_description') }}</textarea>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input id="business_position" type="text" class="form-control @error('business_position') is-invalid @enderror mb-2" name="business_position" value="{{ old('business_position') }}" placeholder="Please enter the tradesperson position in the business">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input id="business_contact_phone" type="text" class="form-control @error('business_contact_phone') is-invalid @enderror mb-2" name="business_contact_phone" value="{{ old('business_contact_phone') }}" placeholder="Please enter the tradesperson contact business phone">
          ...
          <h5 class="text-primary my-3"><b>Tradesperson Images</b></h5>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <div class="custom-file">
                ...
                <input type="file" class="custom-file-input" name="image" id="image" aria-describedby="tradespersonImage">
              </div> {{-- custom-file --}}
              @error('image')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <div class="custom-file">
                ...
                <input type="file" class="custom-file-input" name="logo" id="logo" aria-describedby="tradespersonLogo">
              </div> {{-- custom-file --}}
              @error('logo')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
          ...
          <div class="form-group row">
            <div class="col-md-8 offset-md-3">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('tradespersons.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- modal --}}
              {{-- reset modal --}}
              <a href="{{ route('tradespersons.index') }}" class="btn btn-dark">
