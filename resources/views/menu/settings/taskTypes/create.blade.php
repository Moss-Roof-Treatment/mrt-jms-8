...
@section('title', '- Task Types - Create New Task Type')
...
<section>
  <div class="container py-5">
    ...
    {{-- create new task type form --}}
    <p class="text-primary my-3"><b>Create New Task Type</b></p>

    <div class="row">
      <div class="col-sm-7">

        <form action="{{ route('task-type-settings.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row mb-0">
            <div class="col-md-8 offset-md-3">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('task-type-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- reset modal --}}
              {{-- cancel button --}}
              <a href="{{ route('task-type-settings.index') }}" class="btn btn-dark">
