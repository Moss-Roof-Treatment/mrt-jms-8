...
@section('title', '- Product Tags - Create New Product Tags')
  ...
  <div class="container py-5">
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <form action="{{ route('product-tag-settings.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row mb-0">
            <div class="col-md-8 offset-md-3">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('product-tag-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- modal --}}
              {{-- reset modal --}}
              <a href="{{ route('product-tag-settings.index') }}" class="btn btn-dark">
...
<script>
  ...
  var image = image.getElementById("image");
  image.onchange = function(){
    if (image.files.length > 0)
    {
      image.getElementById('image_name').innerHTML = image.files[0].name;
    }
  };
</script>
@endpush