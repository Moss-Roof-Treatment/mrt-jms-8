...
@section('title', '- Quote Sent Statuses - Create New Quote Sent Status')
...
<section>
  <div class="container py-5">
    ...
    {{-- title --}}
    <h3 class="text-secondary mb-0">QUOTE SENT STATUS</h3>
    <h5>Create New Quote Sent Status</h5>
    {{-- title --}}

    {{-- navigation --}}
    <div class="row pt-3">
      <div class="col-sm-3 pb-3">
        <a href="{{ route('quote-sent-status-settings.index') }}" class="btn btn-dark btn-block">
          <i class="fas fa-bars mr-2" aria-hidden="true"></i>Quote Sent Status Menu
        </a>
      </div> {{-- col-sm-3 pb-3 --}}
    </div> {{-- row pt-3 --}}
    {{-- navigation --}}

    {{-- create quote sent status form --}}
    <div class="row">
      <div class="col-sm-7">

        <p class="text-primary my-3"><b>Create New Quote Sent Status</b></p>

        <form action="{{ route('quote-sent-status-settings.store') }}" method="POST">
          @csrf
          ...
          <div class="form-group row">
            <div class="col-md-9 offset-md-2">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('quote-sent-status-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- modal --}}
              {{-- reset modal --}}
              <a href="{{ route('quote-sent-status-settings.index') }}" class="btn btn-dark">
