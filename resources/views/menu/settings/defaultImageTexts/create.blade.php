...
@section('title', '- Default Image Texts - Create New Default Image Text')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New Default Image Text</h5>
    {{-- title --}}
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <p class="text-primary my-3"><b>Create New Default Image Text</b></p>

        <form action="{{ route('default-image-text-settings.store') }}" method="POST">
          @csrf
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('default-image-text-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
