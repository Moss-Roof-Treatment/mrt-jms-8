...
@section('title', '- Login Statuses - Create New Login Status')
  ...
  <div class="container py-5">
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <p class="text-primary my-3"><b>Create New Login Status</b></p>

        <form action="{{ route('login-statuses-settings.store') }}" method="POST">
          @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <textarea class="form-control @error('message') is-invalid @enderror mb-2" type="text" name="message" rows="5" placeholder="Please enter the message" style="resize:none">{{ old('message') }}</textarea>
              @error('message')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('login-statuses-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
