...
@section('title', '- Account Classes - Create New Account Class')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New Account Class</h5>
    {{-- title --}}
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <p class="text-primary my-3"><b>Create New Account Class</b></p>

        <form action="{{ route('account-classes.store') }}" method="POST">
          @csrf
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('account-classes.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
