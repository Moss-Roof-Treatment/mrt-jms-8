...
@section('title', '- Discount Code - Create New Discount Code')
  ...
  <div class="container py-5">
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <p class="text-primary my-3"><b>Create New Discount Code</b></p>

        <form action="{{ route('discount-code-settings.store') }}" method="POST" enctype="multipart/form-data">
          @csrf

          <div class="form-group row">
            <label for="code" class="col-md-3 col-form-label text-md-right">Code</label>
            <div class="col-md-8">
              <input type="text" class="form-control @error('code') is-invalid @enderror mb-2" name="code" id="code" value="{{ @old('code') }}" placeholder="Please enter the code" autofocus>
              @error('code')
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" class="form-control @error('percent_off') is-invalid @enderror mb-2" name="percent_off" id="percent_off" value="{{ @old('percent_off') }}" placeholder="Please enter the percent off">
              @error('percent_off')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="form-group row">
            <div class="col-md-8 offset-md-3">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="isActiveRadioInline1" name="is_active" class="custom-control-input @error('is_active') is-invalid @enderror mt-2" value="0" @if (old('is_active') == 0) checked @endif>
                <label class="custom-control-label" for="isActiveRadioInline1">Is Not Active</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="isActiveRadioInline2" name="is_active" class="custom-control-input @error('is_active') is-invalid @enderror mt-2" value="1" @if (old('is_active') == 1) checked @endif>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('discount-code-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
