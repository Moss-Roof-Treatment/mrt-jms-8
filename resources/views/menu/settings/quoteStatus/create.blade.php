...
@section('title', '- Quote Statuses - Create New Quote Status')
...
<section>
  <div class="container py-5">
    ...
    {{-- create quote status form --}}
    <div class="row">
      <div class="col-sm-7">

        <p class="text-primary my-3"><b>Create New Quote Status</b></p>

        <form action="{{ route('quote-status-settings.store') }}" method="POST">
          @csrf
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('quote-status-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
