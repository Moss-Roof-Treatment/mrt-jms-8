...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('terms-and-conditions-items.create') }}" class="btn btn-primary btn-block">
          <i class="fas fa-plus mr-2" aria-hidden="true"></i>New Item
        </a>
      </div> {{-- col pb-3 --}}
            ...
            @foreach ($all_items as $item)
              <tr>
                ...
                <td class="text-center">
                  ...
                  @else
                    <a href="{{ route('terms-and-conditions-items.edit', $item->id) }}" class="btn btn-primary btn-sm">
                      <i class="fas fa-edit mr-2" aria-hidden="true"></i>Edit
                    </a>
                  @endif
                  {{-- modal start --}}
                  @if ($item->is_delible == 0)
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="{{ route('terms-and-conditions-items.destroy', $item->id) }}" method="POST">
                              @method('DELETE')
                              @csrf
