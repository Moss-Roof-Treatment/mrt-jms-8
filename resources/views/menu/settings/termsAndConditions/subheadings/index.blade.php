...
@section('title', '- Terms and Conditions - View Terms and Conditions Subheadings')
...
<section>
  <div class="container py-5">
    ...
    <h5>Terms and Conditions Subheadings</h5>
    {{-- title --}}
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      ...
      <div class="col pb-3">
        <a href="{{ route('terms-and-conditions-subheadings.create') }}" class="btn btn-primary btn-block">
          <i class="fas fa-plus mr-2" aria-hidden="true"></i>New Subheading
        </a>
      </div> {{-- col pb-3 --}}
    </div> {{-- row row-cols-1 row-cols-sm-4 pt-3 --}}
    {{-- navigation --}}

    {{-- headings index table --}}
    <h5 class="text-primary my-3"><b>All Subheadings</b></h5>

    @if (!$all_subheadings->count())
            ...
            @foreach ($all_subheadings as $subheading)
              <tr>
                ...
                <td class="text-center">
                  @if ($subheading->is_editable == 0)
                    <a href="#" class="btn btn-primary btn-sm disabled" tabindex="-1" role="button" aria-disabled="true">
                      <i class="fas fa-edit mr-2" aria-hidden="true"></i>Edit
                    </a>
                  @else
                    <a href="{{ route('terms-and-conditions-subheadings.edit', $subheading->id) }}" class="btn btn-primary btn-sm">
                      <i class="fas fa-edit mr-2" aria-hidden="true"></i>Edit
                    </a>
                  @endif
                  {{-- modal start --}}
                  @if ($subheading->is_delible == 0)
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="{{ route('terms-and-conditions-subheadings.destroy', $subheading->id) }}" method="POST">
                              @method('DELETE')
                              @csrf
