            ...
            @foreach ($inspection_types as $inspection_type)  
              <tr>
                ...
                <td class="text-center">
                  <a href="{{ route('inspection-type-settings.edit', $inspection_type->id) }}" class="btn btn-primary btn-sm">
                    <i class="fas fa-edit mr-2" aria-hidden="true"></i>Edit
                  </a>
                  {{-- delete modal --}}
                  {{-- modal button --}}
                  <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirm-delete-button-{{ $inspection_type->id }}">
