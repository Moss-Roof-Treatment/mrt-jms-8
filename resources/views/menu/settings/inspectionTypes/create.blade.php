...
@section('title', '- Settings - Create New Inspection Type')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New Inspection Type</h5>
    {{-- title --}}
    ...
    <div class="row pt-3">
      <div class="col-sm-3 pb-3">
        <a href="{{ route('inspection-type-settings.index') }}" class="btn btn-dark btn-block">
          <i class="fas fa-bars mr-2" aria-hidden="true"></i>Inspection Type Menu
        </a>
      </div> {{-- col-sm-3 pb-3 --}}
    </div> {{-- row pt-3 --}}
    {{-- navigation --}}
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <p class="text-primary my-3"><b>Create New Inspection Type</b></p>

        <form action="{{ route('inspection-type-settings.store') }}" method="POST">
          @csrf
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('inspection-type-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
