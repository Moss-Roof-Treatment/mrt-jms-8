...
@section('title', '- Settings - Customer Leads Statuses - Create New Customer Leads Status')
...
<section>
    <div class="container py-5">
        ...
        <h5>Create New Customer Leads Status</h5>
        {{-- title --}}
        ...
        <div class="row">
            <div class="col-sm-7">
                ...
                <p class="text-primary my-3"><b>Create New Customer Leads Status</b></p>

                <form action="{{ route('customer-lead-statuses.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <a href="{{ route('customer-lead-statuses.create') }}" class="btn btn-dark btn-block">
                                            <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                                        </a>
                                    </div> {{-- modal-body --}}
                                </div> {{-- modal-content --}}
