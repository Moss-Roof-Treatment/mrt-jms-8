        ...
        <div class="container py-5">
            ...
            <div class="row pt-3">
                <div class="col-sm-3 pb-3">
                    <a class="btn btn-dark btn-block" href="{{ route('building-style-post-settings.index') }}">
                        <i class="fas fa-bars mr-2" aria-hidden="true"></i>Building Type Posts Menu
                    </a>
                </div> {{-- col-sm-3 pb-3 --}}
                <div class="col-sm-3 pb-3">
                    <a class="btn btn-primary btn-block" href="{{ route('building-style-post-settings.edit', $selected_building_style_post->id) }}">
                ...
                <div class="col-sm-3 pb-3">
                    {{-- delete modal --}}
                    {{-- modal button --}}
                    <button class="btn btn-danger btn-block" data-toggle="modal" data-target="#deleteModal{{ $selected_building_style_post->id }}" type="button">
