                            ...
                            @foreach ($all_building_style_posts as $building_style)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-primary btn-sm" href="{{ route('building-style-post-settings.show', $building_style->id) }}">
                                            <i class="fas fa-eye mr-2" aria-hidden="true"></i>View
                                        </a>
                                        <a class="btn btn-primary btn-sm" href="{{ route('building-style-post-settings.edit', $building_style->id) }}">
                                            <i class="fas fa-edit mr-2" aria-hidden="true"></i>Edit
                                        </a>
                                        {{-- delete modal --}}
                                        {{-- modal button --}}
                                        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $building_style->id }}" type="button">
