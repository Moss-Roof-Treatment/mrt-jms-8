...
@section('title', '- Settings - Create New Building Style Post')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New Building Style Post</h5>
    {{-- title --}}
    ...
    <div class="row pt-3">
      <div class="col-sm-3 pb-3">
        <a href="{{ route('building-style-post-t-settings.index') }}" class="btn btn-dark btn-block">
          <i class="fas fa-bars mr-2" aria-hidden="true"></i>Building Style Post Menu
        </a>
      </div> {{-- col-sm-3 pb-3 --}}
    </div> {{-- row pt-3 --}}
    {{-- navigation --}}
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <p class="text-primary my-3"><b>Create New Building Style Post</b></p>
        <form action="{{ route('building-style-post-t-settings.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('building-style-post-t-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
