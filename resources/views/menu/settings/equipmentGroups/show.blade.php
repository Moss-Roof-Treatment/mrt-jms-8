...
<section>
  <div class="container py-5">
    ...
    <p class="text-primary my-3"><b>Equipment Group Details</b></p>
    ...
    <p class="text-primary my-3"><b>Equipment In This Group {{ '(' . $selected_equipment_group->equipments->count() . ')' }}</b></p>
