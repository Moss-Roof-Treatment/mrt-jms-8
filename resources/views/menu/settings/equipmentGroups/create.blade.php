...
@section('title', '- Equipment Groups - Create New Equipment Group')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New Equipment Group</h5>
    {{-- title --}}
        ...
        <form action="{{ route('equipment-group-settings.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row mb-0">
            <div class="col-md-9 offset-md-2">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('equipment-group-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- reset modal --}}
              {{-- cancel button --}}
              <a href="{{ route('equipment-group-settings.index') }}" class="btn btn-dark">
