...
@section('title', '- Equipment Categories - Create New Equipment Category')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New Equipment Category</h5>
    {{-- title --}}
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <p class="text-primary my-3"><b>Create New Category</b></p>

        <form action="{{ route('equipment-category-settings.store') }}" method="POST">
          @csrf
          ...
          <div class="form-group row mb-0">
            <div class="col-md-9 offset-md-2">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('equipment-category-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
              ...
              {{-- reset modal --}}
              {{-- cancel button --}}
              <a href="{{ route('equipment-category-settings.index') }}" class="btn btn-dark">
