...
@section('title', '- Postcodes - Create New Postcode')
  ...
  <div class="container py-5">
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <p class="text-primary my-3"><b>Create New Postcode</b></p>

        <form action="{{ route('postcode-settings.store') }}" method="POST">
          @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control @error('code') is-invalid @enderror mb-2" name="code" id="code" value="{{ old('code') }}" placeholder="Please enter the postcode">
              @error('code')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('postcode-settings.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
