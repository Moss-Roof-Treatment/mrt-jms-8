...
@section('title', '- Search - Global Follow Up Call Search Results')
...
@section('content')
    <section>
        <div class="container-fluid py-5">
            ...
            <h5>Follow Up Call Search Results</h5>
            {{-- title --}}

            {{-- navigation --}}
            <div class="row row-cols-1 row-cols-sm-6 pt-3">
                <div class="col mb-3">
                    <a class="btn btn-dark btn-block" href="{{ route('search.index') }}">
                ...
                <div class="col-sm-2">
                    ...
                    <form action="{{ route('search-follow-up-process-results.show') }}" method="POST">
                        ...
                        <div class="input-group">
                            <select class="custom-select" name="quote_status_id" required>
    ...
    <script>
        $(document).ready(function() {
            $('#datatable').DataTable({
                ...
                ajax: '{{ route('search-follow-up-process-r-dt.create') }}',
                columns: [{
                        data: 'quote_identifier',
