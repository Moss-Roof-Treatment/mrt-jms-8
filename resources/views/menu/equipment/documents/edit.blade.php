...
@section('title', '- Equipment - Edit Selected Document')
...
<section>
  <div class="container py-5">
    ...
    <h5>Edit Selected Document</h5>
    {{-- title --}}

    {{-- navigation --}}
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      <div class="col pb-3">
        <a href="{{ route('equipment.show', $document->equipment_id) }}" class="btn btn-primary btn-block">
    ...
    <h5 class="text-primary my-3"><b>Edit Selected Document</b></h5>

    <div class="row">
      <div class="col-sm-7">

        <form action="{{ route('equipment-documents.update', $document->id) }}" method="POST" enctype="multipart/form-data">
          @method('PATCH')
          @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control @error('title') is-invalid @enderror mb-2" name="title" id="title" value="{{ old('title', $document->title) }}" placeholder="Please enter the title" autofocus>
              @error('title')
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <textarea class="form-control @error('description') is-invalid @enderror mb-2" type="text" name="description" rows="5" placeholder="Please enter the description" style="resize:none">{{ old('description', $document->description) }}</textarea>
              @error('description')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('equipment-documents.edit', $document->id) }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
