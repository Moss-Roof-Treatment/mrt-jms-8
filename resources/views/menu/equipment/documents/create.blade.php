...
@section('title', '- Equipment - Documents - Create New Equipment Document')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New Equipment Document</h5>
    {{-- title --}}
    ...
    <h5 class="text-primary my-3"><b>Create New Document</b></h5>

    <div class="row">
      <div class="col-sm-7">

        <form action="{{ route('equipment-documents.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <div class="custom-file">
                <label class="custom-file-label" for="doc" id="doc_name">Please select an doc to upload</label>
                <input type="file" class="custom-file-input" name="document" id="doc" aria-describedby="doc">
              </div> {{-- custom-file --}}
              @error('doc')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('equipment-documents.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
