...
@section('title', '- Equipment - Create New Equipment')
      ...
      <div class="col-sm-7">
        ...
        <form action="{{ route('equipment.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" class="form-control @error('brand') is-invalid @enderror mb-2" name="brand" id="brand" value="{{ old('brand') }}" placeholder="Please enter the brand">
              @error('brand')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" class="form-control @error('serial_number') is-invalid @enderror mb-2" name="serial_number" id="serial_number" value="{{ old('serial_number') }}" placeholder="Please enter the serial number">
              @error('serial_number')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <select name="equipment_category_id" class="custom-select @error('equipment_category_id') is-invalid @enderror mb-2">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <select name="equipment_group_id" class="custom-select @error('equipment_group_id') is-invalid @enderror mb-2">
