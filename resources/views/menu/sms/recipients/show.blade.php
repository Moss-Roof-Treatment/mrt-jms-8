...
@section('title', '- SMS - SMS Recipient Group - View Selected SMS Recipient Groups')
...
<section>
  <div class="container py-5">
    ...
    <h5>View Selected SMS Recipient Groups</h5>
    {{-- title --}}
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form action="{{ route('sms-recipient-groups.destroy', $selected_group->id) }}" method="POST">
                  @method('DELETE')
                  @csrf
    ...
    <h5 class="text-primary my-3"><b>User Recipients ({{ $users->count() }})</b></h5>
    <div class="table-responsive">
      <table class="table table-bordered table-fullwidth table-striped bg-white">
        <thead class="table-secondary">
          <tr>
        ...
        <tbody>
          @forelse ($users as $user)
            <tr>
              <td>
                <a href="{{ route('customers.show', $user->id) }}" target="_blank">{{ $user->id }}</a>
              </td>
                ...
                <div class="modal fade" id="removeModal{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="removeModal{{$user->id}}Title" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <p class="text-center">Are you sure that you would like to delete this item?</p>
                        <form action="{{ route('sms-recipient-groups.update', $selected_group->id) }}" method="POST">
                          @method('PATCH')
                          @csrf
