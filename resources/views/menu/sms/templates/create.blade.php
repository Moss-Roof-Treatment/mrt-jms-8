...
@section('title', '- SMS - SMS Templates - Create New SMS Template')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New SMS Templates</h5>
    {{-- title --}}
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <h5 class="text-primary my-3"><b>Create New SMS Template</b></h5>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a class="btn btn-dark btn-block" href="{{ route('sms-templates.create') }}">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
