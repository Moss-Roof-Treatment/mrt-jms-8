...
@section('title', '- Invoices - View All Outstanding Invoices')
...
<section>
  <div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-sm-4 pt-3">
      <div class="col pb-3">
        <a href="{{ route('invoices.index') }}" class="btn btn-dark btn-block">
            <i class="fas fa-bars mr-2" aria-hidden="true"></i>Invoices Menu
        </a>
      </div> {{-- col pb-3 --}}
      <div class="col pb-3">
        <a href="{{ route('invoices-paid.index') }}" class="btn btn-primary btn-block">
          <i class="fas fa-file-alt mr-2" aria-hidden="true"></i>Paid Invoices
        </a>
      </div> {{-- col pb-3 --}}
      <div class="col pb-3">
        <a href="{{ route('invoices-outstanding.create') }}" class="btn btn-primary btn-block">
    ...
    <h5 class="text-primary my-3"><b>All Outstanding Invoices</b></h5>
    @if (!$all_invoices->count())
      <div class="card shadow-sm mt-3">
        <div class="card-body text-center">
          <h5>Threre are no outstanding invoices to display</h5>
        </div> {{-- card-body --}}
      </div> {{-- card --}}
    @else
            ...
            @foreach ($all_invoices as $invoice)
              <tr>
                ...
                <td class="text-center">
                  <a href="{{ route('invoices-outstanding.show', $invoice->id) }}" class="btn btn-primary btn-sm">
