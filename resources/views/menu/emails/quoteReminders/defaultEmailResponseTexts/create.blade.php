...
@section('title', '- Quote Reminders - Create New Default Email Response Text')
...
<section>
  <div class="container py-5">
    ...
    <h5>Create New Default Email Response Text</h5>
    {{-- title --}}
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <p class="text-primary my-3"><b>Create New Default Email Response Text</b></p>

        <form action="{{ route('default-email-response-text.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row">
            <div class="col-md-8 offset-md-3">
              <div class="custom-control custom-radio custom-control-inline mb-2">
                <input type="radio" id="typeRadioInline1" name="type" class="custom-control-input @error('type') is-invalid @enderror mt-2" value="0" @if (old('type') == 0) checked @endif>
                <label class="custom-control-label" for="typeRadioInline1">Waiting</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline mb-2">
                <input type="radio" id="typeRadioInline2" name="type" class="custom-control-input @error('type') is-invalid @enderror mt-2" value="1" @if (old('type') == 1) checked @endif>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <a href="{{ route('default-email-response-text.create') }}" class="btn btn-dark btn-block">
                        <i class="fas fa-undo-alt mr-2" aria-hidden="true"></i>Reset
                      </a>
                    </div> {{-- modal-body --}}
                  </div> {{-- modal-content --}}
