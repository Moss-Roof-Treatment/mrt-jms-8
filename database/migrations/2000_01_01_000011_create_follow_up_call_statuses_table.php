...
class CreateFollowUpCallStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('follow_up_call_statuses', function (Blueprint $table) {
            // Primary key.
            $table->id();
    ...
    {
        Schema::dropIfExists('follow_up_call_statuses');
    }
}
