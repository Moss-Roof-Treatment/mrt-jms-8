...
class CreateReminderResponseStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reminder_response_statuses', function (Blueprint $table) {
            // Primary key.
            $table->id();
    ...
    {
        Schema::dropIfExists('reminder_response_statuses');
    }
}
