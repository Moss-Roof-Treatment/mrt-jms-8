...
class CreateQuoteRequestStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quote_request_statuses', function (Blueprint $table) {
            // Primary key.
            $table->id();
    ...
    {
        Schema::dropIfExists('quote_request_statuses');
    }
}
