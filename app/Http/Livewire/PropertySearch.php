...
class PropertySearch extends Component
{
    ...
    public function render()
    {
        ...
        if ($this->material_type_id == null && $this->building_style_id == null && $this->building_type_id == null && $this->job_status_id == null && $this->street_address == null && $this->suburb == null && $this->postcode == null && $this->start_date == null && $this->end_date == null) {
            ...
            })->whereHas('customer', fn ($q) => $q->whereNotNull('mobile_phone')) // Customer with not null email.
            ->with(['customer' => fn ($q) => $q->select('id', 'first_name', 'last_name', 'mobile_phone')])
    ...
    public function submit()
    {
        ...
        $new_user_group = SmsRecipientGroup::create([
        ...
        return redirect()
            ->route('sms-recipient-groups.show', $new_user_group->id)
            ->with('success', 'You have successfully created the new sms recipient group.');
    }
}
