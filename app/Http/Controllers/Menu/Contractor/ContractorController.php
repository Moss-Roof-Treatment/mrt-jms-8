...
namespace App\Http\Controllers\Menu\Contractor;
...
class ContractorController extends Controller
{
    ...
    public function index()
    {
        ...
        $all_contractors = User::where('account_role_id', 4) // Contractors
            ->with('login_status')
            ->get();
        // Return the index view.
        return view('menu.contractors.index')
            ->with('all_contractors', $all_contractors);
    }
    ...
    public function create()
    {
        ...
        return view('menu.contractors.create')
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $new_user->update([
                'image_path' => 'storage/images/contractorImages/' . $filename
            ]);
        }
        // LOGO
        if ($request->hasFile('logo')) {
            ...
            // Update the selected model instance.
            $new_user->update([
                'logo_path' => 'storage/images/contractorLogos/' . $filename
            ]);
        }
        // Return a redirect to the show route.
        return redirect()
            ->route('contractors.show', $new_user->id)
    ...
    public function show($id)
    {
        ...
        if ($selected_user->account_role_id != 4) { // Contractor
        ...
        return view('menu.contractors.show')
            ->with([
