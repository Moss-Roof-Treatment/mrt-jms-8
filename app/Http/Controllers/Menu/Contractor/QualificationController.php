...
class QualificationController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('menu.contractors.qualifications.create')
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('contractor-qualifications.index', $new_qualification->id)
    ...
    public function show($id)
    {
        ...
        return view('menu.contractors.qualifications.show')
    ...
    public function edit($id)
    {
        ...
        $selected_qualification = Qualification::findOrFail($id);
        // Return the show view.
        return view('menu.contractors.qualifications.edit')
            ->with('selected_qualification', $selected_qualification);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('contractor-qualifications.show', $selected_qualification->id)
