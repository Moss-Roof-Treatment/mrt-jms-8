...
class GroupInvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('menu.invoices.groups.index');
    }
    ...
    public function create()
    {
        ...
        $confirmation_number = $_GET['selected_confirmation_number'];
        ...
        $selected_invoices = Invoice::where('confirmation_number', $confirmation_number)
            ->get();
        // Find the required model instance.
        $selected_user = User::find($selected_invoices->first()->user_id);
        // All Invoice IDs.
        ...
        // PAYG
        $item_payg = PayAsYouGoTax::where('confirmation_number', $confirmation_number)->first()->amount ?? 0;
        // Superannuation.
    ...
    public function show($id)
    {
        ...
        return view('menu.invoices.groups.show', [
