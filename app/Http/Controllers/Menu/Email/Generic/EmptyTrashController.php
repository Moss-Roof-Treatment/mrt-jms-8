...
class EmptyTrashController extends Controller
{
    ...
    public function index()
    {
        ...
        $all_trashed_emails = Email::onlyTrashed()->get();
        // Secondary validation.
        if (!$all_trashed_emails->count()) {
            // Return a redirect back.
            return back()
                ->with('warning', 'There are no trashed generic emails to be permanently deleted.');
        }
        ...
        return redirect()
            ...
            ->with('success', 'You have successfully permenently deleted all trashed generic email.');
    }
}
