...
class TrashDatatableController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return Datatables::of($emails)
            ...
            // Deleted at column.
            ->editColumn('deleted_at', function ($email) {
                return $email->deleted_at->format('d/m/y - h:iA');
            })
            // Add options button column.
            ->addColumn('action', 'menu.emails.generic.trashed.actions.actions')
            ->rawColumns(['action'])
            ->make(true);
    }
}
