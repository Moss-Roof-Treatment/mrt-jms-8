...
class TradespersonController extends Controller
{
    ...
    public function index()
    {
        ...
        $all_tradespersons = User::where('account_role_id', 3) // Tradespersons
            ->with('login_status')
            ->get();
        // Return the index view.
        return view('menu.tradespersons.index')
            ->with('all_tradespersons', $all_tradespersons);
    }
    ...
    public function create()
    {
        ...
        return view('menu.tradespersons.create')
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('tradespersons.show', $new_user->id)
    ...
    public function show($id)
    {
        ...
        if ($selected_user->account_role_id != 3) { // Tradesperson
        ...
        return view('menu.tradespersons.show')
            ->with([
