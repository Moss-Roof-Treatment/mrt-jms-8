...
class BlogController extends Controller
{
    ...
    public function index()
    {
        ...
        $articles = Article::where('type', 2) // 1 = Blog.
            ->get();
        // Return the index view.
        return view('menu.content.blogs.index')
    ...
    public function create()
    {
        ...
        return view('menu.content.blogs.create')
            ->with([
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('blogs.show', $new_article->id)
            ->with('success', 'You have successfully created a new blog.');
    }
    ...
    public function show($id)
    {
        ...
        return view('menu.content.blogs.show')
            ->with([
    ...
    public function edit($id)
    {
        ...
        return view('menu.content.blogs.edit')
            ->with([
                'selected_article' => $selected_article,
                'all_categories' => $all_categories,
                'all_tags' => $all_tags
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('blogs.show', $id)
            ->with('success', 'You have successfully updated the selected blog.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()
            ->route('blogs.index')
            ->with('success', 'You have successfully deleted the selected blog.');
    }
}
