...
class FollowUpCallController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('menu.search.followUpCalls.index')
            ->with('all_quote_statuses', $all_quote_statuses);
    }
    ...
    public function create()
    {
        ...
        $quotes = Quote::where('quote_status_id', 2) // Pending.
        ...
        return Datatables::of($quotes)
            ...
            ->addColumn('login_count', function ($quote) {
                // Return the customer last login.
                return $quote->customer->user_logins->count();
            })
            // Quote status.
            ...
            ->rawColumns(['last_login_date', 'follow_up_call_status', 'job_type_id', 'image', 'action'])
            ->make(true);
    }
    ...
    {
        // Set The Required Variables.
        // All quote statuses sorted by id.
        $all_quote_statuses = QuoteStatus::all('id', 'title')
            ->sortBy('id');
        // Selected option.
        $selected_option = $request->quote_status_id;
        // Put selected job status id into session.
        session(['filtered_quote_status_id' => $request->quote_status_id]);
        // Return the index view.
        return view('menu.search.followUpCalls.show')
            ->with([
