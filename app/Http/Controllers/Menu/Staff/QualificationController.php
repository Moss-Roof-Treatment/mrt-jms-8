...
class QualificationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('menu.staff.qualifications.index', [
    ...
    public function create()
    {
        ...
        return view('menu.staff.qualifications.create')
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $image_storage_location = 'storage/images/qualifications/' . $filename;
        ...
        return redirect()
            ->route('staff-qualifications.index', $new_qualification->id)
            ->with('success', 'You have successfully created a new staff qualification.');
    }
    ...
    public function show($id)
    {
        ...
        return view('menu.staff.qualifications.show')
    ...
    public function edit($id)
    {
        ...
        $selected_qualification = Qualification::findOrFail($id);
        // Return the show view.
        return view('menu.staff.qualifications.edit')
            ->with('selected_qualification', $selected_qualification);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $selected_qualification->update([
            ...
            'image_path' => $image_storage_location ?? $selected_qualification->image_path,
        ]);

        // Return a redirect to the show route.
        return redirect()
            ->route('staff-qualifications.show', $selected_qualification->id)
    ...
    public function destroy(Request $request, $id)
    {
        ...
        // Return a redirect to the index route.
        return redirect()
            ->route('staff-qualifications.index', ['selected_user_id' => $request->selected_user_id])
