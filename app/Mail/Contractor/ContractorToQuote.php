...
class ContractorToQuote extends Mailable
{
    ...
    public function build()
    {
        ...
        $selected_email_template = EmailTemplate::find(1); // Contractor To Quote.
        // Create the email.
        return $this->markdown('mail.contractors.contractorToQuote')
