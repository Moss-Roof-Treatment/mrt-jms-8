...
class SendQuotePDFEmail extends Mailable
{
    ...
    public function build()
    {
        ...
        $selected_email_template = EmailTemplate::find(18); // Send Quote PDF Email.
        // Create the email.
        return $this->markdown('mail.customers.sendQuotePDF')
